...
movie_data_path = api.read('data/movies.csv', remote='remote_data_storage')
finantial_data_path = api.read(
    'data/finantials.csv', remote='remote_data_storage')
opening_data_path = api.read(
    'data/opening_gross.csv', remote='remote_data_storage')
